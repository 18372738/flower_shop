...
from flower_models.models import Event, Bouquet, Client, Order
...
if __name__ == '__main__':
    ...
    dispatcher.add_handler(CallbackQueryHandler(main_menu_handler, pattern='^(new_order|order_collect|remaining_term|collect_orders|all_orders|)$'))
